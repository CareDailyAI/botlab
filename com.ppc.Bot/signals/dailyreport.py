...
def add_weekly_entry(botengine, location_object, section_id, comment=None, subtitle=None, identifier=None, include_timestamp=False, timestamp_override_ms=None):
    """
    ...
    location_object.distribute_datastream_message(botengine, "daily_report_weekly_entry", content, internal=True, external=False)

def add_monthly_entry(botengine, location_object, section_id, comment=None, subtitle=None, identifier=None, include_timestamp=False, timestamp_override_ms=None):
    """
    Add a section and bullet point the current weekly report
    :param botengine: BotEngine environment
    :param location_object: Location object
...
def report_status_updated(botengine, location_object, report, status=REPORT_STATUS_CREATED, metadata=None):
    """
    ...
    location_object.distribute_datastream_message(botengine, "daily_report_status_updated", content, internal=True, external=False)