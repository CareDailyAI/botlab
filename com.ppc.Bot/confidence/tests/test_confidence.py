...
class TestConfidence():
    ...
    def test_confidence_occupancy_offline(self):
        ...
        assert model_under_test.current_away_confidence() == (CONFIDENCE_OFFLINE, "We don't have enough Motion devices for occupancy away service to work.")
    ...
    def test_confidence_occupancy_low(self):
        ...
        assert model_under_test.current_away_confidence() == (CONFIDENCE_LOW, "Add 1 Motion device to improve the confidence.")

        # 0 Motion / 2 Entry / 0 Lock
    ...
    def test_confidence_occupancy_medium(self):
        ...
        assert model_under_test.current_away_confidence() == (CONFIDENCE_MEDIUM, "Add 1 more Motion device to improve the confidence.")

        # 1 Motion / 0 Entry / 1 Lock
        motion_device = MotionDevice(botengine, location_object, "A", 10038, "")
        motion_device.is_connected = True
    ...
    def test_confidence_sleep_low(self):
        ...
        assert model_under_test.current_confidence() == (CONFIDENCE_LOW, "Add more Motion devices installed inside bedroom to improve the confidence.")
        ...
        assert model_under_test.current_confidence() == (CONFIDENCE_LOW, "Add more Motion devices installed outside bedroom to improve the confidence.")
    ...
    def test_confidence_sleep_medium(self):
        ...
        assert model_under_test.current_confidence() == (CONFIDENCE_MEDIUM, "Add 1 more Motion device to improve the confidence.")
