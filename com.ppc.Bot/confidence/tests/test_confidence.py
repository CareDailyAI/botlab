...
class TestConfidence:
    def test_confidence_occupancy_initialization(self):
        ...
        assert model_under_test.current_away_confidence() == (
            None,
            None,
        ), "Occupancy CSM initializaed prematurely"
    ...
    def test_confidence_occupancy_low(self):
        ...
        location_object.devices = {
            entry_device.device_id: entry_device,
            entry_device_2.device_id: entry_device_2,
        }
        ...
        location_object.devices = {
            lock_device.device_id: lock_device,
            lock_device_2.device_id: lock_device_2,
        }
        ...
        assert model_under_test.current_away_confidence() == (
            CONFIDENCE_LOW,
            "Add 1 Entry device to improve the confidence.",
        )
    ...
    def test_confidence_occupancy_medium(self):
        ...
        location_object.devices = {
            motion_device.device_id: motion_device,
            entry_device.device_id: entry_device,
        }
        ...
        location_object.devices = {
            radar_device.device_id: radar_device,
            entry_device.device_id: entry_device,
        }
        ...
        location_object.devices = {
            motion_device.device_id: motion_device,
            motion_device_2.device_id: motion_device_2,
        }
        ...
        assert model_under_test.current_away_confidence() == (
            CONFIDENCE_MEDIUM,
            "Add 1 more entry device to improve the confidence.",
        )
        ...
        location_object.devices = {
            radar_device.device_id: radar_device,
            radar_device_2.device_id: radar_device_2,
        }
    ...
    def test_confidence_sleep_initialization(self):
        ...
        assert model_under_test is not None, "Missing model"
        assert model_under_test.current_confidence() == (
            None,
            None,
        ), "Sleep CSM initializaed prematurely"
    ...
    def test_confidence_sleep_low(self):
        ...
        motion_device.spaces = [
            {"name": "Bedroom", "spaceId": 0, "spaceType": SPACE_TYPE["bedroom"]}
        ]
    ...
    def test_confidence_sleep_medium(self):
        ...
        motion_device.measurements[MotionDevice.MEASUREMENT_NAME_STATUS] = [
            [0, botengine.get_timestamp()]
        ]

        motion_device_2 = MotionDevice(botengine, location_object, "B", 10038, "")
        motion_device_2.is_connected = True
        motion_device_2.measurements[MotionDevice.MEASUREMENT_NAME_STATUS] = [
            [0, botengine.get_timestamp()]
        ]
        ...
        radar_device = RadarDevice(botengine, location_object, "B", 2000, "")
        radar_device.is_connected = True
        radar_device.measurements[RadarDevice.MEASUREMENT_NAME_OCCUPANCY_TARGET] = [
            [0, botengine.get_timestamp()]
        ]
        ...
        radar_device_2 = RadarDevice(botengine, location_object, "B", 2000, "")
        radar_device_2.is_connected = True
        radar_device_2.measurements[RadarDevice.MEASUREMENT_NAME_OCCUPANCY_TARGET] = [
            [0, botengine.get_timestamp()]
        ]
        ...
        location_object.devices = {
            motion_device.device_id: motion_device,
            motion_device_2.device_id: motion_device_2,
            motion_device_3.device_id: motion_device_3,
        }
        ...
        location_object.devices = {
            radar_device.device_id: radar_device,
            radar_device_2.device_id: radar_device_2,
            radar_device_3.device_id: radar_device_3,
        }
    ...
    def test_confidence_sleep_high(self):
        ...
        motion_device_3 = MotionDevice(botengine, location_object, "C", 10038, "")
        motion_device_3.is_connected = True
        motion_device_3.measurements[MotionDevice.MEASUREMENT_NAME_STATUS] = [
            [0, botengine.get_timestamp()]
        ]
        ...
        assert model_under_test.current_confidence() == (
            CONFIDENCE_HIGH,
            "We have high confidence on the sleep service.",
        )
        ...
        radar_device_3 = RadarDevice(botengine, location_object, "C", 2000, "")
        radar_device_3.is_connected = True
        radar_device_3.measurements[RadarDevice.MEASUREMENT_NAME_OCCUPANCY_TARGET] = [
            [0, botengine.get_timestamp()]
        ]
