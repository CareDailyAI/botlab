...
class RadarVayyarDevice(RadarDevice):
    ...
    MEASUREMENT_NAME_DRY_CONTRACT_ACTIVATION_DURATION = (
        "vyrc.dryContactActivationDuration"
    )
    ...
    def get_leds(self, botengine):
        ...
        if RadarVayyarDevice.MEASUREMENT_NAME_LED_MODE in self.measurements:
            if len(self.measurements[RadarVayyarDevice.MEASUREMENT_NAME_LED_MODE]) > 0:
                return self.measurements[RadarVayyarDevice.MEASUREMENT_NAME_LED_MODE][
                    0
                ][0]
    ...
    def get_volume(self, botengine):
        ...
        if RadarVayyarDevice.MEASUREMENT_NAME_VOLUME in self.measurements:
            if len(self.measurements[RadarVayyarDevice.MEASUREMENT_NAME_VOLUME]) > 0:
                return self.measurements[RadarVayyarDevice.MEASUREMENT_NAME_VOLUME][0][
                    0
                ]
    ...
    def is_detecting_stability_event(self, botengine):
        ...
        botengine.get_logger(f"{__name__}.{__class__.__name__}").debug(
            "|is_detecting_stability_event() "
            + utilities.Color.RED
            + "status={} learning_mode_status={}".format(
                status, self.learning_mode_status
            )
            + utilities.Color.END
        )
        if (
            status is not None
            and not self.learning_mode_status != RadarVayyarDevice.LEARNING_MODE_DONE
        ):
            return (
                status == RadarDevice.FALL_STATUS_CONFIRMED
                or status == RadarDevice.FALL_STATUS_DETECTED
            )
        return False
    ...
    def did_stop_detecting_fall(self, botengine):
        ...
        botengine.get_logger(f"{__name__}.{__class__.__name__}").debug(
            ...
            + utilities.Color.RED
            + "status={} previous_status={} did_update={} learning_mode_status={}".format(
                status, previous_status, did_update, self.learning_mode_status
            )
            + utilities.Color.END
        )
        if (
    ...
    def did_update_fall_learning(self, botengine):
        ...
        """
        return (
            RadarVayyarDevice.MEASUREMENT_NAME_FALL_LEARNING in self.last_updated_params
        )
    ...
    def get_fall_learning(self, botengine):
        ...
        if RadarVayyarDevice.MEASUREMENT_NAME_FALL_LEARNING in self.measurements:
            return self.measurements[RadarVayyarDevice.MEASUREMENT_NAME_FALL_LEARNING][
                0
            ][0]
        return None
    ...
    def did_boot(self, botengine):
        ...
        if hasattr(self, "last_alert"):
            if "boot" in self.last_alert:
                return (
                    self.last_alert["boot"]["timestamp_ms"] == botengine.get_timestamp()
                )
        return False
    ...
    def did_press_button(self, botengine):
        ...
        if hasattr(self, "last_alert"):
            if "button_press" in self.last_alert:
                return (
                    self.last_alert["button_press"]["timestamp_ms"]
    ...
    def set_led_mode(self, botengine, led_mode):
        ...
        """
        botengine.send_command(
            self.device_id, RadarVayyarDevice.MEASUREMENT_NAME_LED_MODE, int(led_mode)
        )
    ...
    def set_volume(self, botengine, volume):
        ...
        """
        botengine.send_command(
            self.device_id, RadarVayyarDevice.MEASUREMENT_NAME_VOLUME, int(volume)
        )
    ...
    def set_learning_mode(self, botengine, learning_mode):
        ...
        if learning_mode:
            if self.learning_mode_status != RadarVayyarDevice.LEARNING_MODE_GOING:
                botengine.get_logger(f"{__name__}.{__class__.__name__}").info(
                    "|set_learning_mode() starting learning"
                )
                self.learning_mode_status = RadarVayyarDevice.LEARNING_MODE_GOING
                end_timestamp_ms = botengine.get_timestamp() + (
                ...
                botengine.get_logger(f"{__name__}.{__class__.__name__}").info(
                    "|set_learning_mode() already going"
                )

        else:
            botengine.get_logger(f"{__name__}.{__class__.__name__}").info(
                "|set_learning_mode() setting as done"
            )
    ...
    def set_silent_mode(self, botengine, silent_mode):
        ...
        """
        botengine.send_command(
            self.device_id, RadarVayyarDevice.MEASUREMENT_NAME_SILENT_MODE, silent_mode
        )
    ...
    def set_target_change_threshold_m(self, botengine, target_change_threshold_m):
        ...
        """
        botengine.get_logger(f"{__name__}.{__class__.__name__}").info(
            "|set_target_change_threshold_m() is no longer supported.  This method will be removed in a future release."
        )
        pass
    ...
    def get_enter_duration(self, botengine):
        ...
        if RadarVayyarDevice.MEASUREMENT_NAME_ENTER_DURATION in self.measurements:
            return self.measurements[RadarVayyarDevice.MEASUREMENT_NAME_ENTER_DURATION][
                0
            ][0]
        return 120
    ...
    def get_exit_duration(self, botengine):
        ...
        if RadarVayyarDevice.MEASUREMENT_NAME_EXIT_DURATION in self.measurements:
            return self.measurements[RadarVayyarDevice.MEASUREMENT_NAME_EXIT_DURATION][
                0
            ][0]
        return 120
    ...
    def set_min_time_of_target_in_fall_location(
        self, botengine, min_time_of_target_in_fall_location
    ):
        """
        ...
        botengine.send_command(
            ...
            min_time_of_target_in_fall_location,
        )
    ...
    def set_dry_contact_activation_duration_sec(
        self, botengine, dry_contact_activation_duration_sec
    ):
        """
        ...
        botengine.send_command(
            ...
            dry_contact_activation_duration_sec,
        )
    ...
    def set_enable_above_th_point_telemetry_enables(
        self, botengine, enable_above_th_point_telemetry_enables
    ):
        """
        ...
        botengine.send_command(
            ...
            enable_above_th_point_telemetry_enables,
        )
    ...
    def set_test_mode(self, botengine, test_mode):
        ...
        """
        botengine.send_command(
            self.device_id, RadarVayyarDevice.MEASUREMENT_NAME_TEST_MODE, test_mode
        )
    ...
    def get_offline_mode(self, botengine):
        ...
        if RadarVayyarDevice.MEASUREMENT_NAME_OFFLINE_MODE in self.measurements:
            return self.measurements[RadarVayyarDevice.MEASUREMENT_NAME_OFFLINE_MODE][
                0
            ][0]
        return True
    ...
    def get_dry_contacts(self, botengine):
        ...
        * vyrc.dryContacts = “primary” and “secondary”
        ...
        if RadarVayyarDevice.MEASUREMENT_NAME_DRY_CONTRACTS in self.measurements:
            return self.measurements[RadarVayyarDevice.MEASUREMENT_NAME_DRY_CONTRACTS][
                0
            ][0]
        return None
    ...
    def set_demo_mode(self, botengine, demo_mode):
        ...
        """
        botengine.send_command(
            self.device_id, RadarVayyarDevice.MEASUREMENT_NAME_DEMO_MODE, demo_mode
        )
    ...
    def set_door_events(self, botengine, door_events):
        ...
        """
        botengine.send_command(
            self.device_id, RadarVayyarDevice.MEASUREMENT_NAME_DOOR_EVENTS, door_events
        )
    ...
    def get_door_events(self, botengine):
        ...
        if RadarVayyarDevice.MEASUREMENT_NAME_DOOR_EVENTS in self.measurements:
            return self.measurements[RadarVayyarDevice.MEASUREMENT_NAME_DOOR_EVENTS][0][
                0
            ]
        return False
    ...
    def get_out_of_bed_enabled(self, botengine):
        ...
        if RadarVayyarDevice.MEASUREMENT_NAME_OUT_OF_BED in self.measurements:
            return self.measurements[RadarVayyarDevice.MEASUREMENT_NAME_OUT_OF_BED][0][
                0
            ]
        return False
    ...
    def get_sensitive_mode(self, botengine):
        ...
        if RadarVayyarDevice.MEASUREMENT_NAME_SENSITIVE_MODE in self.measurements:
            return self.measurements[RadarVayyarDevice.MEASUREMENT_NAME_SENSITIVE_MODE][
                0
            ][0]
        return False
    ...
    def set_min_events_for_first_decision(
        self, botengine, min_events_for_first_decision
    ):
        """
    ...
    # TODO: Check for ceiling at 45 degree installs
    ...
    def set_wall_mount(self, botengine, sensor_mounting=RadarDevice.SENSOR_MOUNTING_WALL, sensor_height_m=1.5):
        """
    ...
    def set_room_boundaries(self, botengine, content={}):
        ...
        **Offset**: A ceiling installation may be offset 0.5 meters along the Y-axis in either direction.  The total distance along the Y-axis must be adjusted so that it is 5.0 meters or less.
        ...
        if (
            ...
            or mounting_type == RadarDevice.SENSOR_MOUNTING_WALL_45_DEGREE
        ):
            ...
            mounting_type == RadarDevice.SENSOR_MOUNTING_CEILING
            or mounting_type == RadarDevice.SENSOR_MOUNTING_CEILING_45_DEGREE
        ):
        ...
        all_params.append(
            {"name": RadarVayyarDevice.MEASUREMENT_NAME_X_MIN, "value": x_min_meters}
        )

        all_params.append(
            {"name": RadarVayyarDevice.MEASUREMENT_NAME_X_MAX, "value": x_max_meters}
        )

        all_params.append(
            {"name": RadarVayyarDevice.MEASUREMENT_NAME_Y_MIN, "value": y_min_meters}
        )

        all_params.append(
            {"name": RadarVayyarDevice.MEASUREMENT_NAME_Y_MAX, "value": y_max_meters}
        )

        all_params.append(
            {"name": RadarVayyarDevice.MEASUREMENT_NAME_Z_MIN, "value": z_min_meters}
        )

        all_params.append(
            {"name": RadarVayyarDevice.MEASUREMENT_NAME_Z_MAX, "value": z_max_meters}
        )
    ...
    def get_room_boundaries(self, botengine):
        ...
        if RadarVayyarDevice.MEASUREMENT_NAME_X_MIN in self.measurements:
            if len(self.measurements[RadarVayyarDevice.MEASUREMENT_NAME_X_MIN]) > 0:
                room["x_min_meters"] = self.measurements[
                    RadarVayyarDevice.MEASUREMENT_NAME_X_MIN
                ][0][0]
                if (
                    self.measurements[RadarVayyarDevice.MEASUREMENT_NAME_X_MIN][0][1]
                    > room["updated_ms"]
                ):
        ...
        if RadarVayyarDevice.MEASUREMENT_NAME_X_MAX in self.measurements:
            if len(self.measurements[RadarVayyarDevice.MEASUREMENT_NAME_X_MAX]) > 0:
                room["x_max_meters"] = self.measurements[
                    RadarVayyarDevice.MEASUREMENT_NAME_X_MAX
                ][0][0]
                if (
                    self.measurements[RadarVayyarDevice.MEASUREMENT_NAME_X_MAX][0][1]
                    > room["updated_ms"]
                ):
                    room["updated_ms"] = self.measurements[
                        RadarVayyarDevice.MEASUREMENT_NAME_X_MAX
        ...
        if RadarVayyarDevice.MEASUREMENT_NAME_Y_MIN in self.measurements:
            if len(self.measurements[RadarVayyarDevice.MEASUREMENT_NAME_Y_MIN]) > 0:
                room["y_min_meters"] = self.measurements[
                    RadarVayyarDevice.MEASUREMENT_NAME_Y_MIN
                ][0][0]
                if (
                    self.measurements[RadarVayyarDevice.MEASUREMENT_NAME_Y_MIN][0][1]
                    > room["updated_ms"]
                ):
                    room["updated_ms"] = self.measurements[
                        RadarVayyarDevice.MEASUREMENT_NAME_Y_MIN
        ...
        if RadarVayyarDevice.MEASUREMENT_NAME_Y_MAX in self.measurements:
            if len(self.measurements[RadarVayyarDevice.MEASUREMENT_NAME_Y_MAX]) > 0:
                room["y_max_meters"] = self.measurements[
                    RadarVayyarDevice.MEASUREMENT_NAME_Y_MAX
                ][0][0]
                if (
                    self.measurements[RadarVayyarDevice.MEASUREMENT_NAME_Y_MAX][0][1]
                    > room["updated_ms"]
                ):
                    room["updated_ms"] = self.measurements[
                        RadarVayyarDevice.MEASUREMENT_NAME_Y_MAX
        ...
        if RadarVayyarDevice.MEASUREMENT_NAME_Z_MIN in self.measurements:
            if len(self.measurements[RadarVayyarDevice.MEASUREMENT_NAME_Z_MIN]) > 0:
                room["z_min_meters"] = self.measurements[
                    RadarVayyarDevice.MEASUREMENT_NAME_Z_MIN
                ][0][0]
                if (
                    self.measurements[RadarVayyarDevice.MEASUREMENT_NAME_Z_MIN][0][1]
                    > room["updated_ms"]
                ):
                    room["updated_ms"] = self.measurements[
                        RadarVayyarDevice.MEASUREMENT_NAME_Z_MIN
        ...
        if RadarVayyarDevice.MEASUREMENT_NAME_Z_MAX in self.measurements:
            if len(self.measurements[RadarVayyarDevice.MEASUREMENT_NAME_Z_MAX]) > 0:
                room["z_max_meters"] = self.measurements[
                    RadarVayyarDevice.MEASUREMENT_NAME_Z_MAX
                ][0][0]
                if (
                    self.measurements[RadarVayyarDevice.MEASUREMENT_NAME_Z_MAX][0][1]
                    > room["updated_ms"]
                ):
                    room["updated_ms"] = self.measurements[
                        RadarVayyarDevice.MEASUREMENT_NAME_Z_MAX
        ...
        if RadarVayyarDevice.MEASUREMENT_NAME_SENSOR_MOUNTING in self.measurements:
            if (
                ...
                room["mounting_type"] = self.measurements[
                    RadarVayyarDevice.MEASUREMENT_NAME_SENSOR_MOUNTING
                ][0][0]
                if (
                    self.measurements[
        ...
        if RadarVayyarDevice.MEASUREMENT_NAME_SENSOR_HEIGHT in self.measurements:
            if (
                len(self.measurements[RadarVayyarDevice.MEASUREMENT_NAME_SENSOR_HEIGHT])
                > 0
            ):
                room["sensor_height_m"] = self.measurements[
                    RadarVayyarDevice.MEASUREMENT_NAME_SENSOR_HEIGHT
                ][0][0]
                if (
                    self.measurements[RadarVayyarDevice.MEASUREMENT_NAME_SENSOR_HEIGHT][
                        0
                    ][1]
                    > room["updated_ms"]
                ):
    ...
    def get_subregion_index(self, botengine, subregion):
        ...
        for idx, raw_subregion in enumerate(self.get_raw_subregions(botengine)):
            if (
                raw_subregion.get("name") == subregion.get("name")
                and raw_subregion.get("xMin") == subregion.get("x_min_meters")
                and raw_subregion.get("xMax") == subregion.get("x_max_meters")
                and raw_subregion.get("yMin") == subregion.get("y_min_meters")
                and raw_subregion.get("yMax") == subregion.get("y_max_meters")
            ):
                botengine.get_logger(f"{__name__}.{__class__.__name__}").info(
