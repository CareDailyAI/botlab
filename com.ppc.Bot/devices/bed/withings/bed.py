...
class WithingsSleepDevice(BedDevice):
    """
    ...
    def get_device_type_name(self):
        ...
        return _("Withings Sleep Tracking Mat")
    ...
    def is_in_bed(self, botengine):
        """
        Is in bed?
        :return: True if the person is in bed.
        """
        if WithingsSleepDevice.MEASUREMENT_NAME_BED_STATUS in self.measurements:
            return self.measurements[WithingsSleepDevice.MEASUREMENT_NAME_BED_STATUS][0][0]
    ...
    def did_change_state(self, botengine=None):
        ...
        """
        return (WithingsSleepDevice.MEASUREMENT_NAME_BED_STATUS in self.last_updated_params)
