...
# Data Stream Address
DATASTREAM_ADDRESS = "send_sms"

a = "Presence Family: It appears you went on vacation. Presence Family has dialed down your 'Thermostat' to save energy and turned off your 'Hot Water Heater'. Do you live with any pets? (1=Yes; 2=No)"
b = "Presence Family: Thanks. Are you leaving any pets home while you're on vacation? (1=Yes; 2=No)"
c = "Presence Family: Okay David, since there are not going to be any pets left at home, we'll dial down the 'Thermostat' further to save energy while you're out. Enjoy your trip!"
