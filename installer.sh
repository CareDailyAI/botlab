...
if command -v python3 > /dev/null 2>&1; then
  ...
  curl --progress-bar https://raw.githubusercontent.com/peoplepower/botengine/master/botengine -o /tmp/botengine.tmp
  curl --progress-bar https://raw.githubusercontent.com/peoplepower/botengine/master/botengine_bytecode -o /tmp/botengine_bytecode.tmp
