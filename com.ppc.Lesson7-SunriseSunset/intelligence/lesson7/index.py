...
MICROSERVICES = {
    ...
    "DEVICE_MICROSERVICES": {
        ...
        # Light Bulbs
        10036: [
            {"module": "intelligence.lesson7.device_lighting_microservice", "class": "DeviceLightingMicroservice"}
            ],
    ...
    "LOCATION_MICROSERVICES": [
        ...
        # from all devices.
            ...
            {"module": "intelligence.lesson7.location_lighting_microservice", "class": "LocationLightingMicroservice"}
        ]
}
