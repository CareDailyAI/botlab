...
#    "schedule": "0 0/1 * * * ?",
# 
# This schedule says "Fire every minute". Realistically, your app should avoid such a heavy
...
def run(composer):
    ...
    logger = composer.get_logger()
    inputs = composer.get_inputs()              # Get the inputs to this app from Composer
    
# This is what my inputs look like when the app runs. Pretty sparse.
#
# {
#   'trigger': 1,
#   'time': 1465683540431
