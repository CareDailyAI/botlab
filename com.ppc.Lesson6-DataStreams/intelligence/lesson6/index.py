...
MICROSERVICES = {
    ...
    "DEVICE_MICROSERVICES": {
        ...
        # Light Bulbs
        10036: [
            {"module": "intelligence.lesson6.device_datastream_microservice", "class": "DeviceDataStreamMicroservice"}
            ],
    ...
    "LOCATION_MICROSERVICES": [
        ...
        # from all devices.
            ...
            {"module": "intelligence.lesson6.location_datastream_microservice", "class": "LocationDataStreamMicroservice"}
        ]
}
